<template lang="">
  <section class="bg-white dark:bg-custom-dark">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
      ...
      >
        <a
          href="#"
          class="bg-yellow-100 text-yellow-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-md dark:bg-gray-700 dark:text-yellow-400 mb-2"
        >
          <svg
        ...
        <a
          href="#"
          class="inline-flex justify-center items-center py-2.5 px-5 text-base font-medium text-center text-white rounded-lg bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 dark:focus:ring-yellow-900"
        >
          Read more
          <svg
      ...
      <div class="grid md:grid-cols-2 gap-8">
        ...
        >
          <a
            href="#"
            class="bg-red-100 text-red-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-md dark:bg-gray-700 dark:text-red-400 mb-2"
          >
            <svg
              class="w-2.5 h-2.5 mr-1.5"
              aria-hidden="true"
          ...
          <a
            href="#"
            class="text-yellow-600 dark:text-yellow-500 hover:underline font-medium text-lg inline-flex items-center"
            >Read more
            <svg
              class="w-3.5 h-3.5 ml-2"
              aria-hidden="true"
