<template lang="">
  <div class="py-6 px-4 mx-auto max-w-screen-xl items-center flex flex-col">
    <h2
      class="mb-6 lg:mb-8 text-center text-xl font-extrabold text-gray-900 dark:text-white md:text-2xl lg:text-3xl"
    >
      Sering Ditanyakan
    </h2>
    <div id="accordion-collapse" data-accordion="collapse" class="w-full xl:w-3/4">
